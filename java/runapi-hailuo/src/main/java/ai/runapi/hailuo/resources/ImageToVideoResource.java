package ai.runapi.hailuo.resources;
...
public final class ImageToVideoResource extends HailuoResource {
  /** API endpoint path for image to video operations. */
  public static final String ENDPOINT = "/api/v1/hailuo/image_to_video";
