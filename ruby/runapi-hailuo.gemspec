...
Dir.chdir(__dir__) do
  ...
  Gem::Specification.new do |spec|
    ...
    spec.summary = "Hailuo API Ruby SDK for RunAPI"
    spec.description = "The Hailuo Ruby SDK is the language-specific package for Hailuo on RunAPI. Use this package for video generation, animation, and video editing workflows when your application needs request bodies, task status lookup, and consistent RunAPI errors in Ruby."
    ...
    spec.metadata["bug_tracker_uri"] = "https://github.com/runapi-ai/hailuo-sdk/issues"
