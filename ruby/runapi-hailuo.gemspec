...
Dir.chdir(__dir__) do
  ...
  Gem::Specification.new do |spec|
    ...
    spec.summary = "Hailuo API SDKs for JavaScript, Ruby, and Go on RunAPI."
    spec.description = "RunAPI Hailuo SDK for JavaScript, Ruby, and Go"
    spec.homepage = "https://runapi.ai/models/hailuo"
    spec.license = "Apache-2.0"
    spec.required_ruby_version = ">= 3.1.0"
    spec.metadata["homepage_uri"] = "https://runapi.ai/models/hailuo"
    spec.metadata["documentation_uri"] = "https://github.com/runapi-ai/hailuo-sdk/blob/main/README.md"
